...
def test_vr_m3_1_tracking_has_correct_action_scale(
  ...
  """VR M3.1 tracking tasks should use VR_M3_1_ACTION_SCALE."""
  for task_id in vr_m3_1_tracking_task_ids:
    ...
    assert joint_pos_action.scale == VR_M3_1_ACTION_SCALE, (
      f"Task {task_id} action scale mismatch, expected VR_M3_1_ACTION_SCALE"
    )
