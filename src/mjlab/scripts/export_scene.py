...
ENTITY_ALIASES: dict[str, str] = {
  ...
  "vr_h3_1": "mjlab.asset_zoo.robots:get_vr_h3_1_robot_cfg",
  "vr_m3_1": "mjlab.asset_zoo.robots:get_vr_m3_1_robot_cfg",
}
...
class ExportSceneCfg:
  ...
  """Task ID, entity alias, or import path (pkg.module:get_cfg)."""
